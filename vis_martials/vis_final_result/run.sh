...
python vis_transparent_occlusion.py -u data_penetrate/case3-UpperJaw.ply -l data_penetrate/case3_raw-LowerJaw.ply -n case3_raw --vmin -0.1 --vmax 1.0
python vis_transparent_occlusion.py -u data_penetrate/case3-UpperJaw.ply -l data_penetrate/case3_opt-LowerJaw.ply -n case3_opt --vmin -0.1 --vmax 1.0
python vis_transparent_occlusion.py -u data_penetrate/case3-UpperJaw.ply -l data_penetrate/case3_gt-LowerJaw.ply  -n case3_gt  --vmin -0.1 --vmax 1.0
